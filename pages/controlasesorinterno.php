...
<head>
    ...
    <title>Control asesores internos</title>
...
<div id="wrapper">
    ...
    <?php 
        ...
        if($ObjectITSA->checkSession()){  
            if(!$ObjectITSA->checkPermission("controlasesorinterno")) {
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h1 class="page-header"><!-- <i class="fa fa-file-o"></i> --> Control de asesores internos </h1>
                    <?php 
                        if(isset($_POST['guardarUsuario'])) {
                            if($_POST['idAI'] == 0) {
                                $ObjectITSA->registrarAsesorInterno(
                                    $_POST['vUsuario'],
                                    $_POST['vContrasena']
                                );
                            } else {
                                $ObjectITSA->actualizarAsesorInterno(
                                    $_POST['idAI'],
                                    $_POST['vUsuario'],
                                    $_POST['vContrasena']
                                );
                            ...
                            $ObjectITSA->changeStatusAsesorInterno(
                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h2 class="panel-title">Asesor interno</h2>
                            </div>
                        ...
                        <button type="button" class="btn btn-primary pull-right" id="btnNuevoAsesor">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover" id="AITable">
                                    ...
                                    <?php 
                                        $AI_QUERY = $ObjectITSA->getAsesoresInternos();
